...
TRANSLATIONS = {
    "en": {
        ...
        "step2_mode_ptt": "Push-to-talk (hold to record)",
        "step2_mode_toggle": "Toggle (click to start, click to stop)",
    ...
    "pl": {
        ...
        "step2_mode_ptt": "Push-to-talk (przytrzymaj by nagrać)",
        "step2_mode_toggle": "Toggle (kliknij by zacząć, kliknij by skończyć)",
    ...
    "uk": {
        ...
        "step2_mode_ptt": "Push-to-talk (утримувати для запису)",
        "step2_mode_toggle": "Toggle (натисніть для початку/зупинки)",
